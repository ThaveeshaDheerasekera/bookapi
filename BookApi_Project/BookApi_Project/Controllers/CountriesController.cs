...
namespace BookApi_Project.Controllers
{
    ...
    public class CountriesController : Controller
    {
        ...
        private IAuthorRepositiry _authorRepository;

        public CountriesController(ICountryRepository countryRepository, IAuthorRepositiry authorRepository)
        {
        ...
        public IActionResult GetCountryOfAnAuthor(int authorId)
        {
            ...
            var country = _countryRepository.GetCountry(authorId);
